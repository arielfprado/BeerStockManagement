...
public class BeerControllerTest {
    ...
    void whenPOSTIsCalledWithoutRequiredFieldThenAnErrorIsReturned() throws Exception {
        ...
        //then
        mockMvc.perform(post(BEER_API_URL_PATH).contentType(MediaType.APPLICATION_JSON)
                        .content(asJsonString(beerDTO))).andExpect(status().isBadRequest());
    }
   ...
   /* @Test
    ...
    @Test
    void whenGETListWithBeersThenOkStatusIsReturned() throws Exception {
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenGETListWithoutBeersThenOkStatusIsReturned() throws Exception {
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
